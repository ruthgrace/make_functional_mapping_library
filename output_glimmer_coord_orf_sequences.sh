...
do
	...
	./get_orf_sequences_from_glimmer_output.pl "data/genomes/"$filename"_genomic.fna" "data/genomes/"$filename"_feature_table.txt" "data/orfs/"$genus"/"$filename"_orfs.fa"
done
